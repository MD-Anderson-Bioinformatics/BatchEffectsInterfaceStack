 ...
 * @author Tod-Casasent
 */
public class BEIUtils
{
	// *mapped-dir* <- used for searching for hard-coded paths
	final public static String M_OUTPUT = "/BEA/BEI/OUTPUT";
	final public static String M_PROPS = "/BEA/BEI/PROPS";
	final public static String M_UTILS = "/BEA/BEI/UTILS";
	final public static String M_WEBSITE = "/BEA/BEI/WEBSITE";
	...
	static public String uploadTextOnlyFile(Part thePart, String theSavePath, HttpServlet theServlet, String theSuccessString) throws FileNotFoundException, IOException, SAXException, TikaException
	{
		...
		try(OutputStream out = new FileOutputStream(tmpPath))
		{
			...
			try (TikaInputStream stream = TikaInputStream.get(thePart.getInputStream()))
			{
				...
				theServlet.log("File being uploaded to " + tmpPath);
			}
		}
		...
		try (BufferedReader br = new BufferedReader(new FileReader(tmpPath)))
		{
			...
			{
				theServlet.log("File being cleaned to " + theSavePath);
				String line;
