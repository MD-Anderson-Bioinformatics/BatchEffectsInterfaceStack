...
public class JOBnew extends BEIServletMixin
{
	...
	protected void internalProcess(HttpServletRequest request, StringBuffer theBuffer) throws Exception
	{
		...
		Files.write(new File(zipResultsDir, "source_id.txt").toPath(), "BEI-RUN".getBytes(StandardCharsets.UTF_8));
		...
		Files.write(new File(zipResultsDir, "version_type.txt").toPath(), "BEI-DATA".getBytes(StandardCharsets.UTF_8));
		////////////////////////////////////////////////////////////////////////
		// ZIP Data Directory
		////////////////////////////////////////////////////////////////////////
