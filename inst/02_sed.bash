...
sed -e "s|<USERID>|${USER_ID}|g" -e "s|<GROUPID>|${GROUP_ID}|g" ${BASEDIR}/build/bei-stack/bev-image/Dockerfile_template > ${BASEDIR}/build/bei-stack/bev-image/Dockerfile
...
sed -e "s|<USERID>|${USER_ID}|g" -e "s|<GROUPID>|${GROUP_ID}|g" -e "s|<GROUPID>|${GROUP_ID}|g" ${BASEDIR}/build/bei-stack/mbatch-image/Dockerfile_template > ${BASEDIR}/build/bei-stack/mbatch-image/Dockerfile
...
sed -e "s|<BEV-PORT>|${BEV_PORT}|g" -e "s|<BEI-PORT>|${BEI_PORT}|g" -e "s|<SUBNET>|${SUBNET}|g" -e "s|<ENVIRON>|${ENVIRON}|g" -e "s|<BEI-IMAGETXT>|${BEI_IMAGETXT}|g" -e "s|<BEI-DESIREDTAG>|${BEI_DESIREDTAG}|g" -e "s|<GDC-DESIREDTAG>|${GDC_DESIREDTAG}|g" -e "s|<MBATCH-IMAGETXT>|${MBATCH_IMAGETXT}|g" -e "s|<MBATCH-DESIREDTAG>|${MBATCH_DESIREDTAG}|g" -e "s|<BEV-IMAGETXT>|${BEV_IMAGETXT}|g" -e "s|<BEV-DESIREDTAG>|${BEV_DESIREDTAG}|g" -e "s|<PROP-DIR>|${PROP_DIR}|g" -e "s|<JOB-OUTPUT-DIR>|${JOB_OUTPUT_DIR}|g" -e "s|<WEBSITE-DIR>|${WEBSITE_DIR}|g" -e "s|<UTIL-DIR>|${UTIL_DIR}|g" ${BASEDIR}/build/bei-stack/docker-compose_template.yml > ${BASEDIR}/build/bei-stack/docker-compose.yml
