...
echo "START GitLabCi bei-stack 02_dockerSed"
...
echo "BEI_IMAGEURL=${BEI_IMAGEURL}"
...
# #- <SHAIDY-DIR>:/BEI/SHAIDY

if [ "${LOCAL_UID}" != "" ]; then
	echo "do local Dockerfile"
	rm -f ${BASE_DIR}/bei-image/Dockerfile_newuser
	sed -e "s|<IMAGEURL>|${DOCKERFILE_URL_BEI}|g" \
	    -e "s|<USERID>|${USER_ID}|g" \
	    -e "s|<LOCALUID>|${LOCAL_UID}|g" \
	    ${BASE_DIR}/bei-image/Dockerfile_newuser_template > ${BASE_DIR}/bei-image/Dockerfile_newuser
